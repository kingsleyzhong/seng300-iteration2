...
//		assertFalse("Paid event called", stub2.getEvents().contains("Paid"));
	...
	public void testEnable() {
		scss.coinValidator.disable();
		scss.coinValidator.enable();
		scss.coinValidator.disactivate();
		scss.coinValidator.activate();
	}
